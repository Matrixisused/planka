...
export default {
  ...
  translation: {
    common: {
      ...
      private: 'Частный',
      publicLink_title: 'Публичная ссылка',
      publicLinkDescription: 'Создайте публичную ссылку для доступа к доске без авторизации.',
      publicLinkWarning: 'Любой, у кого есть эта ссылка, сможет просматривать содержимое доски.',
      publicUrl: 'Публичная ссылка',
      publicView: 'Публичный просмотр',
      publicAccess_title: 'Публичный доступ',
      publicAccessDescription: 'Создайте публичную ссылку для доступа к доске без авторизации. Любой, у кого есть эта ссылка, сможет просматривать содержимое доски.',
