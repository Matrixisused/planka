...
export default {
  ...
  MENTIONED_CARDS_FETCH: 'MENTIONED_CARDS_FETCH',
  MENTIONED_CARDS_FETCH__SUCCESS: 'MENTIONED_CARDS_FETCH__SUCCESS',
  MENTIONED_CARDS_FETCH__FAILURE: 'MENTIONED_CARDS_FETCH__FAILURE',
  MEMBER_CARDS_FETCH: 'MEMBER_CARDS_FETCH',
  MEMBER_CARDS_FETCH__SUCCESS: 'MEMBER_CARDS_FETCH__SUCCESS',
  MEMBER_CARDS_FETCH__FAILURE: 'MEMBER_CARDS_FETCH__FAILURE',
  ...
  CARD_MEMBERSHIP_CREATE__SUCCESS: 'CARD_MEMBERSHIP_CREATE__SUCCESS',
  CARD_MEMBERSHIP_CREATE__FAILURE: 'CARD_MEMBERSHIP_CREATE__FAILURE',
  CARD_MEMBERSHIP_CREATE_HANDLE: 'CARD_MEMBERSHIP_CREATE_HANDLE',
  CARD_MEMBERSHIP_UPDATE: 'CARD_MEMBERSHIP_UPDATE',
  CARD_MEMBERSHIP_UPDATE__SUCCESS: 'CARD_MEMBERSHIP_UPDATE__SUCCESS',
  CARD_MEMBERSHIP_UPDATE__FAILURE: 'CARD_MEMBERSHIP_UPDATE__FAILURE',
  CARD_MEMBERSHIP_UPDATE_HANDLE: 'CARD_MEMBERSHIP_UPDATE_HANDLE',
  CARD_MEMBERSHIP_DELETE: 'CARD_MEMBERSHIP_DELETE',
  CARD_MEMBERSHIP_DELETE__SUCCESS: 'CARD_MEMBERSHIP_DELETE__SUCCESS',
  CARD_MEMBERSHIP_DELETE__FAILURE: 'CARD_MEMBERSHIP_DELETE__FAILURE',
  CARD_MEMBERSHIP_DELETE_HANDLE: 'CARD_MEMBERSHIP_DELETE_HANDLE',

  /* List memberships */

  LIST_MEMBERSHIP_CREATE: 'LIST_MEMBERSHIP_CREATE',
  LIST_MEMBERSHIP_CREATE__SUCCESS: 'LIST_MEMBERSHIP_CREATE__SUCCESS',
  LIST_MEMBERSHIP_CREATE__FAILURE: 'LIST_MEMBERSHIP_CREATE__FAILURE',
  LIST_MEMBERSHIP_CREATE_HANDLE: 'LIST_MEMBERSHIP_CREATE_HANDLE',
  LIST_MEMBERSHIP_UPDATE: 'LIST_MEMBERSHIP_UPDATE',
  LIST_MEMBERSHIP_UPDATE__SUCCESS: 'LIST_MEMBERSHIP_UPDATE__SUCCESS',
  LIST_MEMBERSHIP_UPDATE__FAILURE: 'LIST_MEMBERSHIP_UPDATE__FAILURE',
  LIST_MEMBERSHIP_UPDATE_HANDLE: 'LIST_MEMBERSHIP_UPDATE_HANDLE',
  LIST_MEMBERSHIP_DELETE: 'LIST_MEMBERSHIP_DELETE',
  LIST_MEMBERSHIP_DELETE__SUCCESS: 'LIST_MEMBERSHIP_DELETE__SUCCESS',
  LIST_MEMBERSHIP_DELETE__FAILURE: 'LIST_MEMBERSHIP_DELETE__FAILURE',
  LIST_MEMBERSHIP_DELETE_HANDLE: 'LIST_MEMBERSHIP_DELETE_HANDLE',
  ...
  PUBLIC_TOKEN_CREATE: 'PUBLIC_TOKEN_CREATE',
  PUBLIC_TOKEN_CREATE__SUCCESS: 'PUBLIC_TOKEN_CREATE__SUCCESS',
  PUBLIC_TOKEN_CREATE__FAILURE: 'PUBLIC_TOKEN_CREATE__FAILURE',
  PUBLIC_TOKEN_DELETE: 'PUBLIC_TOKEN_DELETE',
  PUBLIC_TOKEN_DELETE__SUCCESS: 'PUBLIC_TOKEN_DELETE__SUCCESS',
  PUBLIC_TOKEN_DELETE__FAILURE: 'PUBLIC_TOKEN_DELETE__FAILURE',
  PUBLIC_BOARD_FETCH: 'PUBLIC_BOARD_FETCH',
  PUBLIC_BOARD_FETCH__SUCCESS: 'PUBLIC_BOARD_FETCH__SUCCESS',
  PUBLIC_BOARD_FETCH__FAILURE: 'PUBLIC_BOARD_FETCH__FAILURE',
};
