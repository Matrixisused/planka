...
import CardMembershipsStep from '../../card-memberships';
...
const ProjectContent = React.memo(() => {
  ...
  const handleDirectAccessUserSelect = useCallback(
    (userId, options) => {
      dispatch(
        entryActions.createCardMembershipInCurrentCard({
          userId,
          ...options,
        }),
      );
  ...
  const handleDirectAccessUserDeselect = useCallback(
    (userId) => {
      dispatch(entryActions.deleteCardMembershipInCurrentCard(userId));
    },
    [dispatch],
  );
              ...
              <div className={styles.actions}>
                ...
                {canUseMembers && (
                  <CardMembershipsPopup
                    currentUserIds={userIds}
                    onUserSelect={handleDirectAccessUserSelect}
                    onUserDeselect={handleDirectAccessUserDeselect}
                  >
                    <Button fluid className={classNames(styles.actionButton, styles.hidable)}>
                      <Icon name="key" className={styles.actionIcon} />
                      {t('common.directAccess')}
                    </Button>
                  </CardMembershipsPopup>
                )}
                {canUseLabels && (
