...
const ActionsStep = React.memo(({ onClose }) => {
  ...
  const { withSubscribe, withCustomFieldGroups, withTrashEmptier, withPublicLink } = useSelector((state) => {
  ...
  const handlePublicLinkClick = useCallback(() => {
    dispatch(entryActions.openPublicLinkModal(board.id));
    onClose();
  }, [onClose, dispatch, board.id]);
    ...
    <>
      ...
      <Popup.Content>
        <Menu secondary vertical className={styles.menu}>
          ...
          {withPublicLink && (
            <Menu.Item className={styles.menuItem} onClick={handlePublicLinkClick}>
